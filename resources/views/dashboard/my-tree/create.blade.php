<x-layouts.dashboard>
    ...
    <h1 class="text-2xl font-bold mb-4">My Tree</h1>
        ...
        <form action="/dashboard/my-tree" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="username" id="username" value="{{ old('username') }}"
                    class="px-4 border rounded-lg gap-2 form-control w-full py-2 outline-none border-[var(--gray-300)] focus:border-[var(--sea-blue-100)]" />
                @error('username')
                    <small class="text-red-700">Must contain letters and numbers</small>
                @enderror
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <div class="flex gap-4 mt-1 mb-1">
                    <label>
                        <input type="radio" name="leg" value="LEFT"> Left
                    </label>
                    <label>
                        <input type="radio" name="leg" value="RIGHT"> Right
                    </label>
                </div>
                @error('username')
                    <small class="text-red-700">{{ $message }}</small>
