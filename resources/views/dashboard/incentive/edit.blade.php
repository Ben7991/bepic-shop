    ...
    <div
        ...
        <form action="/dashboard/incentives/{{ $incentive->id }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="distributor_award" id="distributor_award" value="{{ $incentive->distributor_award }}"
            ...
            <div class="mb-5">
                ...
                <input type="text" name="sponsor_award" id="sponsor_award" value="{{ $incentive->sponsor_award }}"
                    class="flex items-center px-4 border rounded-lg gap-2 form-control w-full py-2 outline-none border-[var(--gray-300)] focus:border-[var(--sea-blue-100)]" />
                @error('sponsor_award')
                    <small class="text-red-700">{{ $message }}</small>
                @enderror
