...
<aside
    class="bg-[var(--gray-1000)] drawer--hide lg:w-[300px!important] transition-[width] h-full
            fixed top-0 left-0 overflow-y-auto py-8 xl:py-10 lg:static lg:h-auto z-20 lg:z-0"
    id="side-drawer">
    ...
    <div class="flex flex-col gap-3 w-4/5 mx-auto">
        ...
        @if (Auth::user()->role === 'DISTRIBUTOR')
            <a href="/dashboard/purchase-history"
                class="flex gap-2 items-center py-2 px-4 rounded-lg {{ $title == 'Purchase History' ? 'bg-[var(--sea-blue-100)] text-white' : 'hover:bg-[var(--gray-300)]' }}">
